...
drop policy if exists vacation_requests_rw_policy on public.vacation_requests;
...
drop policy if exists admin_delete_vacation_requests_policy on public.vacation_requests;
